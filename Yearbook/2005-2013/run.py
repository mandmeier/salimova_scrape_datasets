...
def main(argv: list[str] | None = None) -> int:
    ...
    p = argparse.ArgumentParser(description="stats.gov.cn yearbook runner (2005–2013: HTML tables).")
    ...
    p.add_argument("--download-pages", action="store_true", help="Download HTML table pages (offline bundle).")
    ...
    out_dir = (
        args.out
        or os.path.join("artifacts", "yearbook", "2005-2013", str(args.year))
    )
